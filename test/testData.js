...
var date = require('../src/index.js').cal;
...
describe('Convert Date', function () {
    it('1776/07/04 is not valid date', function () {
        date.convertDate(new Date(1776, 07, 04)).should.equal(false);
    });
...
describe('Start Date', function () {
    it('First Republican Year = 22 Sept 1792', function () {
        date.getStartDate(date.getRepublicanYear(new Date(1793, 0, 1))).should.equal(new Date(1792, 8, 22).setUTCHours(0, 0, 0, 0));
    });
    it('Twelfth Republican Year = 24 Sept 1803', function () {
        date.getStartDate(date.getRepublicanYear(new Date(1803, 8, 29))).should.equal(new Date(1803, 8, 24).setUTCHours(0, 0, 0, 0));
    });
    it('Fourteenth Republican Year = 23 Sept 1805', function () {
        date.getStartDate(date.getRepublicanYear(new Date(1805, 8, 25))).should.equal(new Date(1805, 8, 23).setUTCHours(0, 0, 0, 0));
    });
